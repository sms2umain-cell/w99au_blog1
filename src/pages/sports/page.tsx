...
export default function SportsPage() {
  ...
  useEffect(() => {
    updateSEO({
      title: 'W99AU Sports Betting Australia | Live Odds & Betting Tips 2025',
      description: 'W99AU sports betting at W99AU Casino Australia. Expert betting tips, live odds, match analysis for AFL, NRL, cricket, tennis and more. Competitive odds, live betting, cash out options and exclusive promotions.',
      keywords: 'W99AU sports betting, sports betting Australia, live odds, betting tips, AFL betting, NRL betting, cricket betting, tennis betting, live betting, cash out, Australian sports',
      canonical: 'https://w99aud.com/sports',
      ogType: 'website',
  ...
  const categories = [
    { name: 'All', count: sportsArticles.length },
    ...Array.from(new Set(sportsArticles.map(article => article.category))).map(category => ({
      name: category,
      count: sportsArticles.filter(article => article.category === category).length
    }))
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        ...
        {/* Featured Article */}
        <FeaturedArticle article={sportsArticles[0]} />
      </main>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Explore <strong className="text-yellow-600">W99AU Sports Betting</strong> Categories</h2>
            <p className="text-xl text-gray-600">Browse our comprehensive collection of <strong>sports betting Australia</strong> articles and guides</p>
          </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="text-sm text-gray-600 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <strong className="text-gray-900">{sportsArticles.length}</strong>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                {filteredArticles.map((article) => (
                  ...
                  >
                    <div className="relative h-48 overflow-hidden">
                      <img 
                        src={article.image} 
                        alt={`${article.title} - W99AU Sports Betting Guide`}
